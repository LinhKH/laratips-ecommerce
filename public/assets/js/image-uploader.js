    ...
    $.fn.imageUploader = function (options) {
        ...
        plugin.init = function () {
            ...
            plugin.each(function (i, wrapper) {
                ...
                if (plugin.settings.preloaded.length) {
                    // len = plugin.settings.preloaded.length;
                    // Change style
        ...
        let setPreview = function ($container, files) {
            ...
            $(files).each(function (i, file) {
                ...
                if (plugin.settings.preloaded.length) {
                    $uploadedContainer.append(createImg(URL.createObjectURL(file), dataTransfer.items.length + plugin.settings.preloaded.length));
                }else{
                    $uploadedContainer.append(createImg(URL.createObjectURL(file), dataTransfer.items.length - 1));
                }
            });
