...
Route::middleware(['auth','admin'])->group(function () {
    ...
    Route::any('profile-settings', [SettingsController::class, 'profile_settings']);
    ...
    // Route::get('orders/{id}/view_order', [OrderController::class, 'view_order']);
    // Route::post('order-product/delivered', [OrderController::class, 'changeDelivery']);
