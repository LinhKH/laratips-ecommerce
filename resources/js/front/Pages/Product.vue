                    ...
                    <div class="col-md-6">
                        <div class="content-box single-product">
                            <Carousel id="gallery" :items-to-show="1" :wrap-around="false" v-model="currentSlide">
                                <Slide v-for="item in product.gallery_img && product.gallery_img.split(',')" :key="item.id">
                                    <div class="carousel__item">
                                        <img class="w-90"
                                            :src="`${baseUrl}/products/${item}`"
                                        />
                                    </div>
                                </Slide>
                            </Carousel>
                            <Carousel
                                ...
                                ref="carousel"
                            >
                                <Slide v-for="(item, index) in product.gallery_img && product.gallery_img.split(',')" :key="index">
                                    
                                    <img @click="slideTo(index)"
                                        class="w-5"
                                        :src="`${baseUrl}/products/${item}`"
                                    />
                                </Slide>
                                        ...
                                        <template v-for="item1 in colors" :key="item1.id">
                                            <li v-if="product.colors?.includes(item1.id)" class="radio-button">
                                                <input type="radio" name="color"
                                                    ...
                                                    :value="item1.id"
                                                    v-model="data.color"
                                                    :checked="c_check(item1)"
                                                />
                                                <label :for="`color${item1.id}`" :style="{ backgroundColor: item1.color_code }"></label>
                                            </li>
                                        </template>
                                    </ul>
                                </div>
                                ...
                                <div class="product-shipping">
                                    ...
                                    >
                                        ...
                                        <option v-for="city in cities"
                                            :key="city.id"
                                            :value="city.id"
                                            :data-p-ship="product.shipping_charges"
                                                
                                            :data-shipping="city.cost_city"
                                        >
                            ...
                            <div class="accordion-item">
                                ...
                                >
                                    <div class="accordion-body">
                                        <table class="table">
                                            <tbody>
                                                <tr v-if="attributes.length > 0" v-for="row in attributes" :key="row.id" class="product-attributes">
                                                    <th>{{ row.title }}</th>
                                                    <template v-for="item1 in attrvalues" :key="item1.id">
