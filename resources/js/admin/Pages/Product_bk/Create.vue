...
import CrossIcon from "@/admin/Components/Icons/Cross.vue";
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div v-if="edit" class="col-span-2">
                            <d viv-if="item.images.length > 0">
                                ...
                                <div class="grid grid-cols-3 gap-6">
                                    <div v-for="image in item.images" :key="image.id"
                                        ...
                                        <div v-html="image.html" class="[&_img]:h-64 [&_img]:w-full [&_img]:object-contain">
                                        </div>
                                    </div>
                                </div>
                            </d>
                            ...
                            <ImageUpload v-if="item.images.length < maxUploadImageCount" model-type="product"
                                :model-id="item.id" :maxFiles="maxUploadImageCount - item.images.length" />
                        </div>
