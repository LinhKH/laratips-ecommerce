...
<template>
    ...
    <BackendLayout>
        <BreadCrumb :breadcrumb='breadcrumb' :title="title" :active='title'>
            <template #add_btn>
                <Link :href="route('admin.attribute-values.create')" class="align-top btn btn-sm btn-primary">Add New</Link>
            </template>
    ...
    :is-deleting="isDeleting" needed-delete="Attribute Value" field-name="value"> </Modal>
</template>
