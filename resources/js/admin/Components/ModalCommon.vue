...
<template>
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" :id="id"
        tabindex="-1" :aria-labelledby="id + 'Label'" aria-modal="true" role="dialog">
